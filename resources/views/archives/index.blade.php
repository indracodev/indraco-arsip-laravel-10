                    ...
                    <tr class="hover:bg-slate-50 dark:hover:bg-slate-900/50 transition">
                        ...
                        <td class="py-4 px-4">
                            ...
                            @elseif($archive->status === 'approved_booked')
                                <span class="px-2.5 py-1 rounded-full text-xs font-bold bg-blue-500/10 text-blue-700 dark:bg-blue-500/20 dark:text-blue-300 border border-blue-500/30">Approved / Booked</span>
