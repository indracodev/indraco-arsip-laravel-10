...
class WarehouseLayoutSeeder extends Seeder
{
    ...
    {
        // 1. Clear old location layout records and warehouse masters to prevent orphan or stale data
        ...
        // 2. Define Rooms / Gudang Sector Objects (2D Canvas Boxes)
        // User Specifications:
        // GA (0 rak), IT (0 rak), R1 (A..F), R2 (A..Z), R3 (A..D), R4 (A..D), R5 (A..J), R6 (A..D)
        $rooms = [
            [
                'location_type' => 'room',
                'room_sector' => 'GA',
        ...
        // 3. Populate Rack Objects per Gudang according to user instructions
        $racksData = [];

        // --- GUDANG GA: 0 rak ---
        // --- GUDANG IT: 0 rak ---

        // --- GUDANG R1: Rak A hingga F (6 rak) ---
        $r1Letters = range('A', 'F');
        ...
        // --- GUDANG R2: Rak A hingga Z (26 rak) ---
        // Arranged in 2 rows of 13: Row 1 (A-M), Row 2 (N-Z)
        $r2Letters = range('A', 'Z');
        ...
        // --- GUDANG R3: Rak A hingga D (4 rak) ---
        $r3Letters = range('A', 'D');
        ...
        // --- GUDANG R4: Rak A hingga D (4 rak) ---
        $r4Letters = range('A', 'D');
        ...
        // --- GUDANG R5: Rak A hingga J (10 rak) ---
        // Arranged in 2 rows of 5: Row 1 (A-E), Row 2 (F-J)
        $r5Letters = range('A', 'J');
        ...
        // --- GUDANG R6: Rak A hingga D (4 rak) ---
        $r6Letters = range('A', 'D');
