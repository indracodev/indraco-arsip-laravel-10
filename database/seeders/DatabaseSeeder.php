...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        // 5. Seed Archives (Various Workflow States)
        // 5a. Archive 1 - Tersimpan di gudang (FIN)
        $arc1 = Archive::create([
        ...
        // 5b. Archive 2 - Pending Verification (HRD)
        Archive::create([
            'box_number' => null,
            'department_id' => $deptHrd->id,
        ...
        // 5c. Archive 3 - Sedang Dipinjam (MKT)
        $arc3 = Archive::create([
        ...
        // 5d. Archive 4 - Mendekati Masa Pemusnahan (Expiry Alert - Expiring Soon)
        $arc4 = Archive::create([
            ...
            'retention_years' => 5,
            'retention_expiry_date' => Carbon::now()->addDays(15)->format('Y-m-d'), // Expiring in 15 days!
        ...
        // 5e. Archive 5 - Telah Dimusnahkan (Destroyed & BAP Recorded)
        $arc5 = Archive::create([
